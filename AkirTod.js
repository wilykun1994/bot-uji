...
if (args.length == 0) return reply(`Contoh: ${prefix + command} Bayu`)
                     sticWait(from)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp?apikey=SESAT&text=${encodeURI(q)}`)
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
                    case 'ttp2':
                    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
...
case 'thunder':
                    ...
                    sticWait(from)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=SESAT&text=${ini_txt}`).then((gambar) => {
...
case 'pubg':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=SESAT&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'wetglass':
...
case 'freefire':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=SESAT&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli}) 
                    })
                    break
...
case 'carvedwood':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=SESAT&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'pornhub':
...
case 'wallgravity':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=SESAT&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'tahta':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/coolgravity?apikey=SESAT&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'bannerlol':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy3/bannerlol?apikey=SESAT&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'logo':
