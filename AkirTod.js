 ...
 *https://www.youtube.com/channel/UCn-kMZEYRnNNCkMzQBzMYKw*
 🪀 GROUP 🪀 : ⤵️⤵️⤵️
 *https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW*
`,"footerText": `
...
{buttonId: `.owner`, buttonText: {displayText: '💓 OWNER-BOT 💓'}, type: 1}
            ...
            "jpegThumbnail": fs.readFileSync('./image/kirtod.jpeg')
}}, MessageType.buttonsMessage,{ quoted: fakeTroli,thumbnail: fs.readFileSync('./image/kirtod.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${ucapanWaktu}`,body:`${pushname}`,mediaType:"2",thumbnail:fs.readFileSync('./image/kirtod.jpeg'),mediaUrl:`https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW`}}})
sendVn(akirasound)
break
////
case 'linkgc':
replly (' https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW ')
sendVn(oniidaisuki)
break
////
case 'script':
...
case 'listsurah':
                   if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=Deffbotz`)
                    get_result = get_result.result
                    ini_txt = 'List Surah:\n'
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=Deffbotz`)
                but = [
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random/meme?apikey=Deffbotz`)
                but = [
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔥MENU🔥' }, type: 1 }
                ,
                { buttonId: `${prefix + command}`, buttonText: { displayText: '➡️GANTI➡️' }, type: 1 }
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/meme/memeindo?apikey=Deffbotz`)
                but = [
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔥MENU🔥' }, type: 1 }
                ,
                { buttonId: `${prefix + command}`, buttonText: { displayText: '➡️GANTI➡️' }, type: 1 }
                ...
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?apikey=Deffbotz`)
                but = [
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔥MENU🔥' }, type: 1 }
                ,
                { buttonId: `${prefix + command}`, buttonText: { displayText: '➡️GANTI➡️' }, type: 1 }
...
if (args.length == 0) return reply(`Contoh: ${prefix + command} Bayu`)
                     sticWait(from)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp?apikey=Deffbotz&text=${encodeURI(q)}`)
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
                    case 'ttp2':
                    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
...
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp2?apikey=Deffbotz&text=${encodeURI(q)}`)
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
                       case 'ttp3':
                       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                       sticWait(from)
if (args.length == 0) return reply(`contoh: ${prefix + command} Bayu`)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp3?apikey=Deffbotz&text=${encodeURI(q)}`)
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
                             case 'attp2':
                             if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                             sticWait(from)
if (args.length == 0) return reply(`contoh: ${prefix + command} Bayu`)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/attp2?apikey=Deffbotz&text=${encodeURI(q)}%F0%9F%91%8B`) 
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
                      case 'attp3':
                      if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                      sticWait(from)
if (args.length == 0) return reply(`contoh: ${prefix + command} Bayu`)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=Deffbotz&text=${encodeURI(q)}`)
KirBotz.sendMessage(from, buffer, sticker, { quoted: fakeTroli })
break
...
case 'hentai4everyone':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=Deffbotz`)
                but = [
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔥MENU🔥' }, type: 1 }
                ,
                { buttonId: `${prefix + command}`, buttonText: { displayText: '➡️GANTI➡️' }, type: 1 }
...
case 'random_hentai_gif':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=Deffbotz`)
                but = [
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔥MENU🔥' }, type: 1 }
                ,
                { buttonId: `${prefix + command}`, buttonText: { displayText: '➡️GANTI➡️' }, type: 1 }
...
case 'thunder':
                    ...
                    sticWait(from)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=Deffbotz&text=${ini_txt}`).then((gambar) => {
...
case 'freefire':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=Deffbotz&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli}) 
                    })
                    break
...
catat = args.join(" ")
sticWait(from)
catat = await getBuffer(`https://api.lolhuman.xyz/api/nulis?text=${catat}&apikey=Deffbotz`)
...
case 'carvedwood':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=Deffbotz&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'pornhub':
...
case 'wallgravity':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=Deffbotz&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'tahta':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/coolgravity?apikey=Deffbotz&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'bannerlol':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy3/bannerlol?apikey=Deffbotz&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `❤️ HENTONGERS-BOT ❤️`, quoted : fakeTroli})
                    })
                    break
case 'logo':
